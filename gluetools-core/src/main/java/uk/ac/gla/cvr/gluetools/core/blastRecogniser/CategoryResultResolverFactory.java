...
public class CategoryResultResolverFactory extends PluginFactory<CategoryResultResolver> {
	...
	public static Multiton.Creator<CategoryResultResolverFactory> creator = new
			Multiton.SuppliedCreator<>(CategoryResultResolverFactory.class, CategoryResultResolverFactory::new);
