...
@CommandClass(
		commandWords={ "string-plus-alignment", "amino-acid" }, 
		description = "Translate amino acids in a FASTA string, given a precomputed alignment with the target reference", 
		docoptUsages = {},
		docoptOptions = {},
		metaTags = { CmdMeta.inputIsComplex }	
)
public class FastaSequenceStringPlusAlignmentAminoAcidCommand extends FastaSequenceBaseAminoAcidCommand 
