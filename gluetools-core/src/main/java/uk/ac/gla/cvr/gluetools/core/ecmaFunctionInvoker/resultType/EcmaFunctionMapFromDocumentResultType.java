...
public class EcmaFunctionMapFromDocumentResultType extends EcmaFunctionResultType<EcmaFunctionMapFromDocumentResult> implements Plugin {
	...
	@Override
	public EcmaFunctionMapFromDocumentResult glueResultFromReturnObject(
		...
		if(scriptObjectMirror.isArray()) {
			throw new EcmaFunctionInvokerException(Code.FUNCTION_RESULT_EXCEPTION, 
					...
					"Return value from mapFromDocumentResultType must not be an array");
		}
		return new EcmaFunctionMapFromDocumentResult(ecmaFunctionInvoker, functionName, scriptObjectMirror);
	}
