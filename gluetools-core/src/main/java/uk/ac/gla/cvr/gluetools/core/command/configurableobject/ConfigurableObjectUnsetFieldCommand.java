...
@CommandClass( 
	...
	description="Unset a field value for the row", 
	furtherHelp="After the command has executed, the row will have no value for the specified field.") 
public class CustomTableRowUnsetFieldCommand extends CustomTableRowModeCommand<UpdateResult> {
