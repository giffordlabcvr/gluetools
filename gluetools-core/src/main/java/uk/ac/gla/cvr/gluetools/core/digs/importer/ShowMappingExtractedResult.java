...
public class ShowMappingExtractedResult extends ListResult {
	...
	public ShowMappingExtractedResult(List<ImportExtractedFieldRule> rules) {
		super(ImportExtractedFieldRule.class, rules, Arrays.asList(DIGS_EXTRACTED_FIELD, GLUE_SEQUENCE_FIELD, GLUE_FIELD_REQUIREMENT), 
