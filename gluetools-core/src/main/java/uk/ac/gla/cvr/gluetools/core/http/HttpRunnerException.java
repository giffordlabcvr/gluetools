...
public class HttpRunnerException extends ModulePluginException {
	...
	public enum Code implements GlueErrorCode {
		REQUEST_IO_ERROR("errorTxt"), 
		ENTITY_STRING_ERROR("errorTxt");
	...
	public HttpRunnerException(Code code, Object... errorArgs) {
		super(code, errorArgs);
	}

	public HttpRunnerException(Throwable cause, Code code,
			Object... errorArgs) {
