...
@CommandClass(
		commandWords={"save-amino-acid-fasta"}, 
		description = "Save FASTA amino acid command document to a file", 
		docoptUsages = {}, 
...
public class SaveAminoAcidFastaCommand extends ModulePluginCommand<OkResult, FastaUtility>{
	...
	protected OkResult execute(CommandContext cmdContext, FastaUtility fastaUtility) {
		Map<String, ProteinSequence> querySequenceMap = FastaUtils.commandDocumentToProteinFastaMap(cmdDocument);
