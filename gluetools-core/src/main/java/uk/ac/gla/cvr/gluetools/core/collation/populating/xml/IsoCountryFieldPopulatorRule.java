...
@PluginClass(elemName="isoCountryFieldPopulator")
public class IsoCountryFieldPopulatorRule extends BaseXmlFieldPopulatorRule {

	private enum IsoCountry {
		...
		GN("Guinea", "Guinea", "GN", "GIN", "324", "Guinea$", "Guinea[^-]"),
		...
		IR("Iran", "Islamic Republic of Iran", "IR", "IRN", "364","Iran"),
		IQ("Iraq", "IQ", "IRQ", "368"),
		...
		LA("People's Democratic Republic of Lao", "LA", "LAO", "418"),
		...
		NE("Niger", "Niger", "NE", "NER", "562", "Niger$", "Niger[^i]"),
		...
		PW("Palau", "PW", "PLW", "585"),
		PS("Palestinian Territory", "PS", "PSE", "275"),
		...
		US("United States", "United States of America", "US", "USA", "840", "United States of America", "United States", "USA"),
	...
	public void configure(PluginConfigContext pluginConfigContext, Element configElem)  {
		...
		setValueConverters(initValueConverters(pluginConfigContext, codeStyle));
		setMainExtractor(initMainExtractor(codeStyle));
	}


	private List<RegexExtractorFormatter> initValueConverters(PluginConfigContext pluginConfigContext, CodeStyle codeStyle) {
		...
		for(IsoCountry isoCountry: IsoCountry.values()) {
			...
			formatter.setOutputTemplate(FreemarkerUtils.templateFromString(output, pluginConfigContext.getFreemarkerConfiguration()));
	...
	private RegexExtractorFormatter initMainExtractor(CodeStyle codeStyle) {
		return null;
	}
