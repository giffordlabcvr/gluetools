...
@CommandClass(
		commandWords={"list", "neighbour-from-document"}, 
		description = "List the neighbours of a placement from a result document in order of decreasing distance", 
		docoptUsages = {},
		furtherHelp = "",
		metaTags = {CmdMeta.inputIsComplex}	
)
public class ListNeighbourFromPlacementDocumentCommand extends BaseListNeighbourCommand {
