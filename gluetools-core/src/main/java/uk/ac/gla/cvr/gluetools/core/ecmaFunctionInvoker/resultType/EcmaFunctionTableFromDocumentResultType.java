...
import uk.ac.gla.cvr.gluetools.core.ecmaFunctionInvoker.EcmaFunctionTableFromDocumentResult;
...
@PluginClass(elemName="tableFromDocumentResultType")
public class EcmaFunctionTableFromDocumentResultType extends EcmaFunctionResultType<EcmaFunctionTableFromDocumentResult> implements Plugin {
	...
	@Override
	public EcmaFunctionTableFromDocumentResult glueResultFromReturnObject(
		...
		if(scriptObjectMirror.isArray()) {
			throw new EcmaFunctionInvokerException(Code.FUNCTION_RESULT_EXCEPTION, 
					...
					"Return value from tableFromDocumentResultType must not be an array");
		}
		return new EcmaFunctionTableFromDocumentResult(ecmaFunctionInvoker, functionName, scriptObjectMirror);
	}
