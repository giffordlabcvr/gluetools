...
@CommandClass(
		commandWords={"list", "query-from-document"}, 
		description = "Summarise the per-query placement results from a result document", 
		docoptUsages = {},
		furtherHelp = "",
		metaTags = {CmdMeta.inputIsComplex}	
)
public class ListQueryFromPlacementDocumentCommand extends BaseListQueryCommand {
