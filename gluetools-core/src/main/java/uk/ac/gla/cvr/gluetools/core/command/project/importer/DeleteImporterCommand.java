...
@PluginClass(elemName="delete-importer")
@CommandClass(description="Delete a sequence importer", 
	docoptUsages={"<importerName>"}) 
public class DeleteImporterCommand extends ProjectModeCommand {
	...
	public CommandResult execute(CommandContext cmdContext) {
		...
		GlueDataObject.delete(objContext, Importer.class, Importer.pkMap(getProjectName(), importerName));
