...
@CommandClass( 
	...
	description="Show a property value for the variation-alignment note") 
public class VarAlmtNoteShowPropertyCommand extends VarAlmtNoteModeCommand<PropertyValueResult> {
