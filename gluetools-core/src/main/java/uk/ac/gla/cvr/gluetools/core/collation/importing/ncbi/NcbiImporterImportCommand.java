...
public class NcbiImporterImportCommand extends ModulePluginCommand<CommandResult, NcbiImporter> implements ProvidedProjectModeCommand {
	...
	protected CommandResult execute(CommandContext cmdContext, NcbiImporter importerPlugin) {
		NcbiImporterStatus ncbiImporterStatus = importerPlugin.doImport(cmdContext);
		if(detailed) {
