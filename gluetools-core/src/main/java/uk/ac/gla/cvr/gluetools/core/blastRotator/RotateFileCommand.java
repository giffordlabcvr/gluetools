...
@CommandClass(
		commandWords={"rotate", "file"}, 
		description = "Apply rotation to sequences in a FASTA file", 
...
public class RotateFileCommand extends ModulePluginCommand<BlastSequenceRotatorResult, BlastSequenceRotator> 
