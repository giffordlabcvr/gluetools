...
@CommandClass( 
	...
	description="Unset a field value for the reference", 
	furtherHelp="After the command has executed, the reference will have no value for the specified field.") 
public class ReferenceUnsetFieldCommand extends ReferenceSequenceModeCommand<UpdateResult> {
