...
public class ScriptObjectMirrorUtils {
    ...
    private static void populateChildCommandObjectFromValue(CommandObject parentCommandObject, String key, Object value) {
        ...
        } else if (value == null || isUndefined(value)) { // Replaced Undefined check
     ...
     * Currently treats null as Undefined; extend logic if needed.
     */
    private static boolean isUndefined(Object obj) {
        return obj == null; // Treat null as Undefined
    }
}
